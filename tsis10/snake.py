...
connection = psycopg2.connect(host="localhost", dbname="postgres", user="postgres", password="nurda2004", port="5432")
cur = connection.cursor()

cur.execute("""CREATE TABLE IF NOT EXISTS users (username VARCHAR(255) NOT NULL);""")
